...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="relative w-full max-x-[1490px] flex items-center justify-between pt-10 mx-auto px-10">
        ...
        <div
          ...
          } left-0 bg-[#dde0e5] h-[410px] transition-all duration-[800mx] shadow-xl z-10 py-8 px-12 rounded-b-xl`}
        >
          <AiOutlineClose
            size={25}
      ...
      <FadeIn delay={0.2} direction="down" padding fullWidth>
        <h1
          className={
            "mt-[90px] text-center text-5xl landing-tight xs:text-[64px] text-white max-w-[1050px]"
          }
        >
          {heroTitle}
        </h1>
